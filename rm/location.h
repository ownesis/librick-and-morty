...
/**
 * \fn void rm_da_location_clear(rm_location_arr_t *location)
...
/**
 * \fn rm_location_t rm_location_get(rm_ctx_t *ctx, uint64_t id)
...
/**
 * \fn rm_location_arr_t *rm_location_get_filter(rm_info_t *info, rm_location_t *filter)
